...
# Initialise the LLM — API key is read automatically from GOOGLE_API_KEY env var,
# or pass api_key=GEMINI_API_KEY explicitly if your env var has a different name.
